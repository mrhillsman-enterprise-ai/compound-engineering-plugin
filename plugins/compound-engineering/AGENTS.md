...
Skills with pipeline mode: `ce:brainstorm`, `ce:plan`, `deepen-plan-beta`, `ce:work`, `ce:work-beta`, `test-browser`, `feature-video`. Document behavioral changes in a `## Pipeline Mode` section within the skill's SKILL.md.
