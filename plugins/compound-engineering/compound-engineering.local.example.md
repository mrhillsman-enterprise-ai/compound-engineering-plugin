...
# Copy this file to .claude/compound-engineering.local.md in your project root.
# All settings are optional — omit any you don't need.

# Enable Codex delegation for ce:work-beta (false = off, codex = on)
# work_delegate: codex
